...
router.get("/stations", deptController.getAllStations);
...
router.post("/stations", deptController.createStation);
...
router.delete("/stations/:stationId", deptController.deleteStation);
